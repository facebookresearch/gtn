...
class CMakeBuild(build_ext):
    def run(self):
        ...
        cmake_version = re.search(r"version\s*([\d.]+)",
                                  out.decode().lower()).group(1)
    ...
    def build_extension(self, ext):
        ...
        cmake_args = [
            ...
            '-DPROJECT_SOURCE_DIR=' + srcdir, '-DGTN_BUILD_PYTHON_BINDINGS=ON',
            '-DGTN_BUILD_PYTHON_BINDINGS_NO_GIL=ON',
            '-DGTN_BUILD_EXAMPLES=OFF', '-DGTN_BUILD_BENCHMARKS=OFF',
